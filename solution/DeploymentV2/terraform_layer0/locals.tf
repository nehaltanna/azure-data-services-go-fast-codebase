locals {
  ...
  bastion_subnet_name          = "AzureBastionSubnet" //Must be this as per azure naming rules  //(var.vm_subnet_name != "" ? var.vm_subnet_name : "${module.naming.subnet.name}-bastion")
  vpn_subnet_name              = "GatewaySubnet" //Must be this as per azure naming rules  // (var.vm_subnet_name != "" ? var.vm_subnet_name : "${module.naming.subnet.name}-vpn")
